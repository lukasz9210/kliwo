			...
			<div className="container">
				<div class="header-top flex v-cent jc-spb">
					<div class="header-top-icons flex v-cent">
						<a class="header-logo" href="https://kliwo.pl">
							<div class="img-holder">
								<img src={`https://kliwo.pl/wp-content/themes/kliwo/images/ikony/logo.png`} alt="Kliwo" />
							</div>
						</a>
						<a href="https://www.facebook.com/deweloper.trzebnica/" target="blank" class="img-holder h-fb">
							<img src={`https://kliwo.pl/wp-content/themes/kliwo/images/ikony/ico_fb.png`} alt="Facebook" />
						</a>
					</div>
					<nav class="main-menu">
					...
					<div class="header-top-big-btns">
						...
						<a class="comparison-header-btn" href="/porownywarka">Porównywarka mieszkań</a>
					</div>
